package com.project.group16.product.controller;
...
public class ProductController {
	...
	// Update stocks
	@PutMapping(value = "/api/product/{prodid}")
	...
	//Verify products by id
	@GetMapping(value = "/api/verifyproduct/{prodid}",produces = MediaType.APPLICATION_JSON_VALUE)
